...
<div class="container">
    ...
    <form action="widget/searchstudent.php" method="post">
        <table align="center">
            <tr>
                <th><input type="text" name="idorname" autocomplete = "off" placeholder="Enter the ID or Name of the student.."></th>
        ...
        if(isset($_GET['type'])){
            ...
            if($_GET['type'] == 'id'){
                ...
                while($row = $result->fetch_assoc()){
                    ...
                    echo '<tr onclick="view('.$row["student_id"].')"><td>'.$row["student_id"].'</td>';
                    echo '<td>'.$name.'</td>';
                    echo '<td>'.$row['student_session'].'</td>';
                    echo '<td>'.$row['student_department'].'</td>';
                    echo '<td>'.$row['student_roll'].'</td>';
