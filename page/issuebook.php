...
<div class="box">
    <form action="widget/issuebookentry.php" method="post">
        <table align="center">
            ...
            echo '<tr><td>Student ID</td><td><input type="text" name="std_id" placeholder = "Student ID Number" autocomplete="off" required="" ></td></tr>';
            echo '<tr><td>ISBN No.</td><td><input type="text" id= "isbn" name="isbn_no" placeholder = "Book ISBN Number" required="" autocomplete="off"></td></tr>';
